...
use crate::domain::material::{from_f64, to_f64, Csp1dQuantity};
...
pub struct LengthAssignmentModelingConfig<V: SolveValue> {
    ...
    pub dynamic_product_ids: BTreeSet<String>,
    /// 分配长度下界 / Assigned length lower bounds
    pub assigned_length_lower_bound: BTreeMap<String, V>,
    /// 分配长度上界 / Assigned length upper bounds
    pub assigned_length_upper_bound: BTreeMap<String, V>,
    /// 超长惩罚 / Over-length penalties
    pub over_length_penalty: BTreeMap<String, V>,
    /// 超长上界 / Over-length upper bounds
    pub over_length_upper_bound: BTreeMap<String, V>,
...
/// 默认长度推导 / Default length derivation
