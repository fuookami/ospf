...
use super::*;
use crate::{MultiArray, Shape, MultiArrayBuilder, AbstractShape, StorageOrder};
use num_traits::Zero;

#[test]
fn test_index_labels() {
    use super::indices::{I, J, K, IndexLabel};
...
#[test]
fn test_index_lists() {
    use super::indices::{I, J, K, Nil, Cons, IndexList, IL2, IL3};
...
fn test_trace() {
    ...
    let a = MultiArrayBuilder::new_by(shape, |i, _| {
        if i % 4 == 0 { 1.0_f64 } else { 0.0_f64 }
    });
