 ...
 * @property loading 提供更换符号的拖车装载模型 / The trailer loading model providing change symbols.
 * @property coefficient 计算每个拖车-位置对惩罚系数的函数 / Function computing the penalty coefficient for each trailer-position pair.
*/
class TrailerChangeLimit(
    ...
    override fun invoke(model: AbstractLinearMetaModel<Flt64>): Try {
        val monomials = orderedTrailers.flatMapIndexed { p1, (trailer1, trailer2) ->
