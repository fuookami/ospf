...
class PayloadMaximizationContext {
     ...
     * @param stowageContext 提供载荷数据的装载上下文 / The stowage context providing payload data
    ...
    */
     ...
     *
     * @param stowageMode 使用的装载模式 / The stowage mode in use
     * @param parameter 求解参数 / The solving parameter
