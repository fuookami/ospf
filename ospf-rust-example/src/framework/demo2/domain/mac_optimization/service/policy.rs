use crate::framework_demo::demo2::domain::mac_optimization::service::limits;
use crate::framework_demo::demo2::domain::mac_optimization::service::pipeline_list_generator::MacOptimizationPipelineStep;
...
pub fn pipeline_specs() -> Vec<PipelineSpec<MacOptimizationPipelineStep>> {
    vec![
        PipelineSpec {
            ...
            apply: limits::apply_balance_limits,
        },
        PipelineSpec {
            priority: 10,
        ...
        PipelineSpec {
            ...
            apply: limits::apply_moment_limits,
        },
    ]
}
