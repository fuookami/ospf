...
$y^{\prime} \in \{ 0, \, 1 \}$: logical value of the polynomial.
...
$Ulp(x)$ can refer to [Unit Linear Piecewise Function](/guide/linear-functional/ulp), using the sampling points $\{ (0, \, 0), \; (p - \epsilon, \, 0), \; (p, \, 1), \; (max(x), \, 1) \}$.
