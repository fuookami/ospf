...
ospf-kotlin has been published to the Maven Central Repository. If using Maven, simply add the corresponding dependencies in the pom.xml file:
...
**1D Bin Packing Development Package:**
...
**2D Bin Packing Development Package:**
...
**3D Bin Packing Development Package:**
...
**1D Cutting Stock Development Package:**
...
**2D Cutting Stock Development Package:**
...
**Gantt Scheduling Development Package:**
...
**Network Flow Planning Development Package:**
