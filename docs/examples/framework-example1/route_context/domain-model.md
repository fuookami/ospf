...
The page documents the current Kotlin implementation, including client assignment rows fixed to zero, the two at-most-one assignment pipelines, and the generated graph/service rules.
