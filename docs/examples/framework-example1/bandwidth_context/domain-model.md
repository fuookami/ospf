...
The canonical page distinguishes the four active pipelines from the existing but unregistered `TransferNodeBandwidthConstraint` and records that no flow-conservation equality is registered.
