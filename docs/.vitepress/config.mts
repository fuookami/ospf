              ...
              items: [
                ...
                { 
                  ...
                  items: [
                    ...
                    { text: 'Quadratic Maximum', link: '/guide/quadratic-functional/quadratic-max' },
                    { text: 'Quadratic Absolute Value', link: '/guide/quadratic-functional/quadratic-abs' },
                    { text: 'Quadratic Inequality Indicator', link: '/guide/quadratic-functional/quadratic-inequality' },
                    { text: 'Quadratic Masking', link: '/guide/quadratic-functional/quadratic-masking' },
                    { text: 'Quadratic Conditional IF', link: '/guide/quadratic-functional/quadratic-if' },
                    { text: 'Quadratic Conditional Interval', link: '/guide/quadratic-functional/quadratic-if-in' },
                    { text: 'Quadratic Conditional If-Then', link: '/guide/quadratic-functional/quadratic-if-then' },
                  ]
                },
              ...
              items: [
                ...
                { 
                  ...
                  items: [
                    ...
                    { text: '二次最大值', link: '/zh-cn/guide/quadratic-functional/quadratic-max' },
                    { text: '二次绝对值', link: '/zh-cn/guide/quadratic-functional/quadratic-abs' },
                    { text: '二次不等式指示函数', link: '/zh-cn/guide/quadratic-functional/quadratic-inequality' },
                    { text: '二次掩码函数', link: '/zh-cn/guide/quadratic-functional/quadratic-masking' },
                    { text: '二次条件 IF', link: '/zh-cn/guide/quadratic-functional/quadratic-if' },
                    { text: '二次条件区间', link: '/zh-cn/guide/quadratic-functional/quadratic-if-in' },
                    { text: '二次条件 If-Then', link: '/zh-cn/guide/quadratic-functional/quadratic-if-then' },
                  ]
                },
