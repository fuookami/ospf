...
| `IntervalTrait`         | Openness abstraction trait                                   |
...
|-----------------------|-------------------------------------|-----------------------------|
| `IntervalValue<T>`    | `ValueRange<T, Closed, Closed>`     | Closed interval `[a, b]`    |
| `HalfOpenInterval<T>` | `ValueRange<T, Closed, Open>`       | Half-open interval `[a, b)` |
| `OpenInterval<T>`     | `ValueRange<T, Open, Open>`         | Open interval `(a, b)`      |
| `DynamicInterval<T>`  | `ValueRange<T, Interval, Interval>` | Runtime-determined openness |
