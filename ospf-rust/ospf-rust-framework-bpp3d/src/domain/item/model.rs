...
use crate::infrastructure::packing_shape::{
    PackingShape3, cuboid_packing_shape, cylinder_packing_shape,
};
...
use ospf_rust_core::variable::{BinaryVariableItem, UContinuousVariableItem, VariableRange};
