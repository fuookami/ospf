 ...
 * 产出偏差目标管线 / Add under-production and over-production penalty terms to the objective function:
 * minimize sum(underPenalty * under_production_i + overPenalty * over_production_i)
 * 在目标函数中添加欠产和超产惩罚项： / minimize sum(underPenalty * under_production_i + overPenalty * over_production_i)
 *
