/**
 * 求解选项配置 / Solve options configuration
*/
...
/**
 * 求解选项，封装求解过程中的可选参数。 / Solve options, encapsulating optional parameters for the solving process.
 *
...
data class SolveOptions(
    ...
    companion object {
        /**
         * 创建求解选项构建器。 / Create a solve options builder.
         *
        ...
        */
        ...
        /**
         * 通过 DSL 块构建求解选项。 / Build solve options via a DSL block.
         *
